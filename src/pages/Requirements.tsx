    ...
    <>
      <div className="backdrop">
        ...
        <div className="requirementsContent">
          ...
          <Yapathon topShit="1. spend at least 3 hours designing your mouse" bottomBitch="use the onshape wakatime extension to track your hours. you can check your hours on the hackatime dashboard. if you have any wakatime/hackatime issues, send a message in #squeak"/>
